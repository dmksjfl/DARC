...
for ((i=1;i<6;i+=1))
do 
	python main.py --env Ant-v2 --save-model --policy DARC --dir './logs/DARC/Ant/r'$i --seed $i --qweight 0.22
	python main.py --env HalfCheetah-v2 --save-model --policy DARC --dir './logs/DARC/HalfCheetah/r'$i --seed $i --qweight 0.1
	python main.py --env Walker2d-v2 --save-model --policy DARC --dir './logs/DARC/Walker2d/r'$i --seed $i --qweight 0.12
